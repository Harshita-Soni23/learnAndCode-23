...
SentimentEvaluator::SentimentEvaluator()
{
    negationWords_ = {
...
double SentimentEvaluator::evaluateFoodItemSentiment(const std::vector<Feedback>& feedbacks, double& rating, std::string& sentimentsString) {
...
std::string SentimentEvaluator::getMostRepetitiveSentiments(const std::vector<std::string>& words) {
...
double SentimentEvaluator::analyzeSentiment(const std::string& comment, std::vector<std::string>& foundSentiments) {
